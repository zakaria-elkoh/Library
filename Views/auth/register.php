...
<body class="bg-black">
    ...
    <div class="max-w-md mx-auto mt-32 p-6 py-12 border rounded-xl">
        ...
        <form class="" action="../../app/Controller/auth/RegistrationController.php" method="post">
            ...
            <button name="submit" type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register</button>
        </form>

        <a href="./login.php" class="text-white mx-auto w-fit block mt-12">Already have an acount?</a>
