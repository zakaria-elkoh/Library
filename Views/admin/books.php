        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                ...
                <li class="bg-gray-700 rounded-lg">
                    <a href="books.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <tbody>
                        ...
                        <?php foreach($books as $book) : ?>
                            ...
                            <tr class="odd:bg-white text-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <a href="./books/delete.php?id=<?= $book['id'] ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
