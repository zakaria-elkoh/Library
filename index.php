                ...
                <?php foreach($books as $book) : ?>
                    <div  class="book flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                        ...
                        <div class="flex flex-col justify-between p-4 leading-normal">
                            ...
                            <a href="./views/user/reservation.php?book_id=<?= $book['id'] ?>" class="text-white w-fit ms-auto mt-6 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Order Now</a>
                        </div>
                    </div>
                <?php endforeach; ?>
