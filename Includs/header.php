...
<?php
    ...
    if (isset($_SESSION['user_role_id'])) { 
        if($_SESSION['user_role_id'] == 2) {
            echo "logged in";
            $button = '<a type="button" href="http://localhost/Library/Views\user\reservatedBook.php" class="text-white cursor-pointer bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Ordered Books</a>';
            $logOutBtn = '<a type="button" href="http://localhost/Library/app/controller/logout.php" class="text-white cursor-pointer bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Log Out</a>';
        } else if($_SESSION['user_role_id'] == 1) {
            $button = '<a type="button" href="./Views/admin/users.php" class="text-white cursor-pointer bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Dashboard</a>';
            $logOutBtn = '<a type="button" href="http://localhost/Library/app/controller/logout.php" class="text-white cursor-pointer bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Log Out</a>';
        }
    }
...
?>
    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="http://localhost/library" class="flex items-center space-x-3 rtl:space-x-reverse">
